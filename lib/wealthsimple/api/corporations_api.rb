...
module Wealthsimple
  class CorporationsApi
    ...
    # @return [Corporation]
    def create_corporation(corporation, opts = {})
      data, _status_code, _headers = create_corporation_with_http_info(corporation, opts)
      return data
    end
    ...
    def create_corporation_with_http_info(corporation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CorporationsApi.create_corporation ..."
      end
      # verify the required parameter 'corporation' is set
      if @api_client.config.client_side_validation && corporation.nil?
        fail ArgumentError, "Missing the required parameter 'corporation' when calling CorporationsApi.create_corporation"
      end
      # resource path
      local_var_path = "/corporations"
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(corporation)
      auth_names = []
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CorporationsApi#create_corporation\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Corporation]
    def get_corporation(corporation_id, opts = {})
      data, _status_code, _headers = get_corporation_with_http_info(corporation_id, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Corporation, Fixnum, Hash)>] Corporation data, response status code and response headers
    def get_corporation_with_http_info(corporation_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CorporationsApi.get_corporation ..."
      end
      # verify the required parameter 'corporation_id' is set
      if @api_client.config.client_side_validation && corporation_id.nil?
        fail ArgumentError, "Missing the required parameter 'corporation_id' when calling CorporationsApi.get_corporation"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Corporation')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CorporationsApi#get_corporation\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Array<String>] :corporation_ids Limits the results only to those with a &#x60;corporation_id&#x60; in the list.
    # @option opts [Array<String>] :external_ids Limits the results only to those with a &#x60;external_id&#x60; in the list.
    # @option opts [String] :created_after Limits the results returned to only those that were created after this date.
    # @option opts [String] :created_before Limits the results returned to only those that were created before this date.
    # @option opts [String] :updated_after Limits the results returned to only those that were updated after this date.
    # @option opts [String] :updated_before Limits the results returned to only those that were updated before this date.
    # @return [CorporationsPaginated]
    def list_corporations(opts = {})
      data, _status_code, _headers = list_corporations_with_http_info(opts)
      return data
    end
    ...
    # @option opts [String] :updated_after Limits the results returned to only those that were updated after this date.
    # @option opts [String] :updated_before Limits the results returned to only those that were updated before this date.
    # @return [Array<(CorporationsPaginated, Fixnum, Hash)>] CorporationsPaginated data, response status code and response headers
    def list_corporations_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CorporationsApi.list_corporations ..."
      end
      if @api_client.config.client_side_validation && !opts[:'offset'].nil? && opts[:'offset'] < 0
        fail ArgumentError, 'invalid value for "opts[:"offset"]" when calling CorporationsApi.list_corporations, must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 250
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling CorporationsApi.list_corporations, must be smaller than or equal to 250.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling CorporationsApi.list_corporations, must be greater than or equal to 1.'
      end
      ...
      query_params[:'corporation_ids'] = @api_client.build_collection_param(opts[:'corporation_ids'], :csv) if !opts[:'corporation_ids'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CorporationsPaginated')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CorporationsApi#list_corporations\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Corporation]
    def update_corporation(corporation_id, corporation, opts = {})
      data, _status_code, _headers = update_corporation_with_http_info(corporation_id, corporation, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Corporation, Fixnum, Hash)>] Corporation data, response status code and response headers
    def update_corporation_with_http_info(corporation_id, corporation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CorporationsApi.update_corporation ..."
      end
      # verify the required parameter 'corporation_id' is set
      if @api_client.config.client_side_validation && corporation_id.nil?
        fail ArgumentError, "Missing the required parameter 'corporation_id' when calling CorporationsApi.update_corporation"
      end
      # verify the required parameter 'corporation' is set
      if @api_client.config.client_side_validation && corporation.nil?
        fail ArgumentError, "Missing the required parameter 'corporation' when calling CorporationsApi.update_corporation"
      end
      # resource path
      local_var_path = "/corporations/{corporation_id}".sub('{' + 'corporation_id' + '}', corporation_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :return_type => 'Corporation')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CorporationsApi#update_corporation\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
