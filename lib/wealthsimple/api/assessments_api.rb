...
module Wealthsimple
  class AssessmentsApi
    ...
    # @return [AssessmentPaginated]
    def list_account_assessments(opts = {})
      data, _status_code, _headers = list_account_assessments_with_http_info(opts)
      return data
    end
    ...
    # @return [Array<(AssessmentPaginated, Fixnum, Hash)>] AssessmentPaginated data, response status code and response headers
    def list_account_assessments_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AssessmentsApi.list_account_assessments ..."
      end
      if @api_client.config.client_side_validation && !opts[:'offset'].nil? && opts[:'offset'] < 0
        fail ArgumentError, 'invalid value for "opts[:"offset"]" when calling AssessmentsApi.list_account_assessments, must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 250
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling AssessmentsApi.list_account_assessments, must be smaller than or equal to 250.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling AssessmentsApi.list_account_assessments, must be greater than or equal to 1.'
      end
      ...
      # resource path
      local_var_path = "/account_assessments"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'AssessmentPaginated')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AssessmentsApi#list_account_assessments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [String] :sort_order The sort direction of the results. (default to desc)
    # @return [AssessmentPaginated]
    def list_client_assessments(opts = {})
      data, _status_code, _headers = list_client_assessments_with_http_info(opts)
      return data
    end
    ...
    # @option opts [String] :sort_order The sort direction of the results.
    # @return [Array<(AssessmentPaginated, Fixnum, Hash)>] AssessmentPaginated data, response status code and response headers
    def list_client_assessments_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AssessmentsApi.list_client_assessments ..."
      end
      if @api_client.config.client_side_validation && !opts[:'offset'].nil? && opts[:'offset'] < 0
        fail ArgumentError, 'invalid value for "opts[:"offset"]" when calling AssessmentsApi.list_client_assessments, must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 250
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling AssessmentsApi.list_client_assessments, must be smaller than or equal to 250.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling AssessmentsApi.list_client_assessments, must be greater than or equal to 1.'
      end
      ...
      # resource path
      local_var_path = "/client_assessments"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'AssessmentPaginated')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AssessmentsApi#list_client_assessments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
