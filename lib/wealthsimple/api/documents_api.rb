...
module Wealthsimple
  class DocumentsApi
    ...
    # @param document Document metadata, this is required
    # @param data binary file document
    # @param [Hash] opts the optional parameters
    # @return [Document]
    def create_document(document, data, opts = {})
      data, _status_code, _headers = create_document_with_http_info(document, data, opts)
      return data
    end
    ...
    def create_document_with_http_info(document, data, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DocumentsApi.create_document ..."
      end
      # verify the required parameter 'document' is set
      if @api_client.config.client_side_validation && document.nil?
        fail ArgumentError, "Missing the required parameter 'document' when calling DocumentsApi.create_document"
      end
      # verify the required parameter 'data' is set
      if @api_client.config.client_side_validation && data.nil?
        fail ArgumentError, "Missing the required parameter 'data' when calling DocumentsApi.create_document"
      end
      # resource path
    ...
    # @param document_id The &#x60;id&#x60; of the Document entity.
    # @param [Hash] opts the optional parameters
    # @return [Document]
    ...
    def get_document_with_http_info(document_id, opts = {})
      ...
      # resource path
      local_var_path = "/documents/{document_id}".sub('{' + 'document_id' + '}', document_id.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [File]
    def get_document__binary(document_id, opts = {})
      data, _status_code, _headers = get_document__binary_with_http_info(document_id, opts)
      return data
    end
    ...
    def get_document__binary_with_http_info(document_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DocumentsApi.get_document__binary ..."
      end
      # verify the required parameter 'document_id' is set
      if @api_client.config.client_side_validation && document_id.nil?
        fail ArgumentError, "Missing the required parameter 'document_id' when calling DocumentsApi.get_document__binary"
      end
      # resource path
      local_var_path = "/documents/{document_id}/file".sub('{' + 'document_id' + '}', document_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'File')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DocumentsApi#get_document__binary\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Array<String>] :tags Limits the results only to those with a tag in the list.
    ...
    # @option opts [Array<String>] :external_ids Limits the results only to those with a &#x60;external_id&#x60; in the list.
    # @option opts [Array<String>] :tags Limits the results only to those with a tag in the list.
    # @return [Array<(DocumentsPaginated, Fixnum, Hash)>] DocumentsPaginated data, response status code and response headers
    def list_documents_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'offset'].nil? && opts[:'offset'] < 0
        fail ArgumentError, 'invalid value for "opts[:"offset"]" when calling DocumentsApi.list_documents, must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 250
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling DocumentsApi.list_documents, must be smaller than or equal to 250.'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'DocumentsPaginated')
      if @api_client.config.debugging
