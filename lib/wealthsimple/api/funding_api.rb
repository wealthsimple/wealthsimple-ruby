...
module Wealthsimple
  class FundingApi
    ...
    # @return [BankAccountWithFundableAccounts]
    def create_a_bank_account(bank_account, opts = {})
      data, _status_code, _headers = create_a_bank_account_with_http_info(bank_account, opts)
      return data
    end
    ...
    # @param bank_account 
    # @param [Hash] opts the optional parameters
    # @return [Array<(BankAccountWithFundableAccounts, Fixnum, Hash)>] BankAccountWithFundableAccounts data, response status code and response headers
    def create_a_bank_account_with_http_info(bank_account, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: FundingApi.create_a_bank_account ..."
      end
      # verify the required parameter 'bank_account' is set
      if @api_client.config.client_side_validation && bank_account.nil?
        fail ArgumentError, "Missing the required parameter 'bank_account' when calling FundingApi.create_a_bank_account"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'BankAccountWithFundableAccounts')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FundingApi#create_a_bank_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def create_deposit_with_http_info(deposit, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: FundingApi.create_deposit ..."
      end
      # verify the required parameter 'deposit' is set
      if @api_client.config.client_side_validation && deposit.nil?
        fail ArgumentError, "Missing the required parameter 'deposit' when calling FundingApi.create_deposit"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Deposit')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FundingApi#create_deposit\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Withdrawal]
    def create_withdrawal(withdrawal, opts = {})
      data, _status_code, _headers = create_withdrawal_with_http_info(withdrawal, opts)
      return data
    end
    ...
    def create_withdrawal_with_http_info(withdrawal, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: FundingApi.create_withdrawal ..."
      end
      # verify the required parameter 'withdrawal' is set
      if @api_client.config.client_side_validation && withdrawal.nil?
        fail ArgumentError, "Missing the required parameter 'withdrawal' when calling FundingApi.create_withdrawal"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FundingApi#create_withdrawal\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param bank_account_id The &#x60;id&#x60; of the Bank Account entity.
    # @param [Hash] opts the optional parameters
    # @return [BankAccountWithFundableAccounts]
    ...
    def get_bank_account_with_http_info(bank_account_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: FundingApi.get_bank_account ..."
      end
      # verify the required parameter 'bank_account_id' is set
      if @api_client.config.client_side_validation && bank_account_id.nil?
        fail ArgumentError, "Missing the required parameter 'bank_account_id' when calling FundingApi.get_bank_account"
      end
      # resource path
      local_var_path = "/bank_accounts/{bank_account_id}".sub('{' + 'bank_account_id' + '}', bank_account_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'BankAccountWithFundableAccounts')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FundingApi#get_bank_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [DepositWithEvents]
    def get_deposit(funds_transfer_id, opts = {})
      data, _status_code, _headers = get_deposit_with_http_info(funds_transfer_id, opts)
      return data
    end
    ...
    # @param funds_transfer_id The &#x60;id&#x60; of the Funds Transfer entity.
    # @param [Hash] opts the optional parameters
    # @return [Array<(DepositWithEvents, Fixnum, Hash)>] DepositWithEvents data, response status code and response headers
    def get_deposit_with_http_info(funds_transfer_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: FundingApi.get_deposit ..."
      end
      # verify the required parameter 'funds_transfer_id' is set
      if @api_client.config.client_side_validation && funds_transfer_id.nil?
        fail ArgumentError, "Missing the required parameter 'funds_transfer_id' when calling FundingApi.get_deposit"
      end
      # resource path
      local_var_path = "/deposits/{deposit_id}".sub('{' + 'funds_transfer_id' + '}', funds_transfer_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'DepositWithEvents')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FundingApi#get_deposit\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_withdrawal_with_http_info(funds_transfer_id, opts = {})
      ...
      # verify the required parameter 'funds_transfer_id' is set
      if @api_client.config.client_side_validation && funds_transfer_id.nil?
        fail ArgumentError, "Missing the required parameter 'funds_transfer_id' when calling FundingApi.get_withdrawal"
      end
      # resource path
      local_var_path = "/withdrawals/{withdrawal_id}".sub('{' + 'funds_transfer_id' + '}', funds_transfer_id.to_s)
    ...
    # @option opts [Array<String>] :external_ids Limits the results only to those with a &#x60;external_id&#x60; in the list.
    # @return [BankAccountsPaginated]
    ...
    # @option opts [Array<String>] :external_ids Limits the results only to those with a &#x60;external_id&#x60; in the list.
    # @return [Array<(BankAccountsPaginated, Fixnum, Hash)>] BankAccountsPaginated data, response status code and response headers
    def list_bank_accounts_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: FundingApi.list_bank_accounts ..."
      end
      if @api_client.config.client_side_validation && !opts[:'offset'].nil? && opts[:'offset'] < 0
        fail ArgumentError, 'invalid value for "opts[:"offset"]" when calling FundingApi.list_bank_accounts, must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 250
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling FundingApi.list_bank_accounts, must be smaller than or equal to 250.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling FundingApi.list_bank_accounts, must be greater than or equal to 1.'
      end
      ...
      query_params[:'external_ids'] = @api_client.build_collection_param(opts[:'external_ids'], :csv) if !opts[:'external_ids'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'BankAccountsPaginated')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FundingApi#list_bank_accounts\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [Array<(DepositsPaginated, Fixnum, Hash)>] DepositsPaginated data, response status code and response headers
    def list_deposits_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: FundingApi.list_deposits ..."
      end
      if @api_client.config.client_side_validation && !opts[:'offset'].nil? && opts[:'offset'] < 0
        fail ArgumentError, 'invalid value for "opts[:"offset"]" when calling FundingApi.list_deposits, must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 250
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling FundingApi.list_deposits, must be smaller than or equal to 250.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling FundingApi.list_deposits, must be greater than or equal to 1.'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'DepositsPaginated')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FundingApi#list_deposits\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_withdrawals(opts = {})
      data, _status_code, _headers = list_withdrawals_with_http_info(opts)
      return data
    end
    ...
    # @option opts [String] :start_date Limits the results returned to only those with a date equal or after this date.
    # @option opts [String] :end_date Limits the results returned to only those with a date not greater than this date.
    # @return [Array<(WithdrawalsPaginated, Fixnum, Hash)>] WithdrawalsPaginated data, response status code and response headers
    def list_withdrawals_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: FundingApi.list_withdrawals ..."
      end
      if @api_client.config.client_side_validation && !opts[:'offset'].nil? && opts[:'offset'] < 0
        fail ArgumentError, 'invalid value for "opts[:"offset"]" when calling FundingApi.list_withdrawals, must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 250
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling FundingApi.list_withdrawals, must be smaller than or equal to 250.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling FundingApi.list_withdrawals, must be greater than or equal to 1.'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'WithdrawalsPaginated')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FundingApi#list_withdrawals\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
