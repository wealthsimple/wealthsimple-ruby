...
module Wealthsimple
  class TrustsApi
    ...
    # @return [Trust]
    def create_trust(trust, opts = {})
      data, _status_code, _headers = create_trust_with_http_info(trust, opts)
      return data
    end
    ...
    # @param trust 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Trust, Fixnum, Hash)>] Trust data, response status code and response headers
    def create_trust_with_http_info(trust, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: TrustsApi.create_trust ..."
      end
      # verify the required parameter 'trust' is set
      if @api_client.config.client_side_validation && trust.nil?
        fail ArgumentError, "Missing the required parameter 'trust' when calling TrustsApi.create_trust"
      end
      # resource path
      local_var_path = "/trusts"
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Trust')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TrustsApi#create_trust\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Trust]
    def get_trust(trust_id, opts = {})
      data, _status_code, _headers = get_trust_with_http_info(trust_id, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Trust, Fixnum, Hash)>] Trust data, response status code and response headers
    def get_trust_with_http_info(trust_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: TrustsApi.get_trust ..."
      end
      # verify the required parameter 'trust_id' is set
      if @api_client.config.client_side_validation && trust_id.nil?
        fail ArgumentError, "Missing the required parameter 'trust_id' when calling TrustsApi.get_trust"
      end
      # resource path
      local_var_path = "/trusts/{trust_id}".sub('{' + 'trust_id' + '}', trust_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Trust')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TrustsApi#get_trust\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Array<String>] :trust_ids Limits the results only to those with a &#x60;trust_id&#x60; in the list.
    ...
    # @return [TrustsPaginated]
    def list_trusts(opts = {})
      data, _status_code, _headers = list_trusts_with_http_info(opts)
      return data
    end
    ...
    # @option opts [String] :updated_after Limits the results returned to only those that were updated after this date.
    # @option opts [String] :updated_before Limits the results returned to only those that were updated before this date.
    # @return [Array<(TrustsPaginated, Fixnum, Hash)>] TrustsPaginated data, response status code and response headers
    def list_trusts_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: TrustsApi.list_trusts ..."
      end
      if @api_client.config.client_side_validation && !opts[:'offset'].nil? && opts[:'offset'] < 0
        fail ArgumentError, 'invalid value for "opts[:"offset"]" when calling TrustsApi.list_trusts, must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 250
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling TrustsApi.list_trusts, must be smaller than or equal to 250.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling TrustsApi.list_trusts, must be greater than or equal to 1.'
      end
      ...
      query_params[:'trust_ids'] = @api_client.build_collection_param(opts[:'trust_ids'], :csv) if !opts[:'trust_ids'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'TrustsPaginated')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TrustsApi#list_trusts\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Trust]
    def update_trust(trust_id, trust, opts = {})
      data, _status_code, _headers = update_trust_with_http_info(trust_id, trust, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Trust, Fixnum, Hash)>] Trust data, response status code and response headers
    def update_trust_with_http_info(trust_id, trust, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: TrustsApi.update_trust ..."
      end
      # verify the required parameter 'trust_id' is set
      if @api_client.config.client_side_validation && trust_id.nil?
        fail ArgumentError, "Missing the required parameter 'trust_id' when calling TrustsApi.update_trust"
      end
      # verify the required parameter 'trust' is set
      if @api_client.config.client_side_validation && trust.nil?
        fail ArgumentError, "Missing the required parameter 'trust' when calling TrustsApi.update_trust"
      end
      # resource path
      local_var_path = "/trusts/{trust_id}".sub('{' + 'trust_id' + '}', trust_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :return_type => 'Trust')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TrustsApi#update_trust\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
