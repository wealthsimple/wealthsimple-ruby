...
module Wealthsimple
  class TransactionsApi
    ...
    # @option opts [String] :effective_date_start Limits the results returned to only those with an &#x60;effective_date&#x60; equal or after this date.
    # @option opts [String] :effective_date_end Limits the results returned to only those with an &#x60;effective_date&#x60; not greater than this date.
    ...
    def list_transactions_with_http_info(account_id, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 250
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling TransactionsApi.list_transactions, must be smaller than or equal to 250.'
      end
      ...
      query_params[:'effective_date_start'] = opts[:'effective_date_start'] if !opts[:'effective_date_start'].nil?
      query_params[:'effective_date_end'] = opts[:'effective_date_end'] if !opts[:'effective_date_end'].nil?
      query_params[:'process_date_start'] = opts[:'process_date_start'] if !opts[:'process_date_start'].nil?
      query_params[:'process_date_end'] = opts[:'process_date_end'] if !opts[:'process_date_end'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'TransactionsPaginated')
      if @api_client.config.debugging
