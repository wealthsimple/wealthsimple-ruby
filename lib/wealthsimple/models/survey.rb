...
module Wealthsimple
  ...
  class Survey
    ...
    attr_accessor :target_portfolio_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'target_portfolio_id')
        self.target_portfolio_id = attributes[:'target_portfolio_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          target_portfolio_id == o.target_portfolio_id &&
    ...
    def hash
      [client_id, locale, created_at, updated_at, current_state, target_portfolio_id, completed_at].hash
    end
