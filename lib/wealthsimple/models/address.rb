...
module Wealthsimple
  ...
  class Address
    ...
    attr_accessor :province_state_region
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'street_number')
      ...
      if attributes.has_key?(:'province_state_region')
        self.province_state_region = attributes[:'province_state_region']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          city == o.city &&
          province_state_region == o.province_state_region &&
    ...
    def hash
      [unit, street_number, street_name, city, province_state_region, postal_code, country].hash
    end
