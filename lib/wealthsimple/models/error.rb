...
module Wealthsimple
  ...
  class Error
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ["bad_request", "conflict", "internal_server_error", "method_not_allowed", "not_acceptable", "not_found", "service_unavailable", "unprocessable_entity"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["bad_request", "conflict", "internal_server_error", "method_not_allowed", "not_acceptable", "not_found", "service_unavailable", "unprocessable_entity"])
    ...
    def hash
      [status, code, message, reference_id, errors].hash
    end
