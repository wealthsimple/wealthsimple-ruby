...
module Wealthsimple
  ...
  class Assessment
    ...
    attr_accessor :creator_full_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'creator_full_name')
        self.creator_full_name = attributes[:'creator_full_name']
      end
    ...
    def valid?
      object_validator = EnumAttributeValidator.new('String', ["assessment"])
      return false unless object_validator.valid?(@object)
      goals_validator = EnumAttributeValidator.new('String', ["mortgage", "retirement", "child_education", "income", "wedding", "speculation", "growth", "capital_preservation", "car", "education", "long_term", "inheritance", "home_deposit", "no_goal", "retirement_income", "other"])
      return false unless goals_validator.valid?(@goals)
      return true
    end
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["assessment"])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] goals Object to be assigned
    def goals=(goals)
      validator = EnumAttributeValidator.new('String', ["mortgage", "retirement", "child_education", "income", "wedding", "speculation", "growth", "capital_preservation", "car", "education", "long_term", "inheritance", "home_deposit", "no_goal", "retirement_income", "other"])
      unless validator.valid?(goals)
        fail ArgumentError, "invalid value for 'goals', must be one of #{validator.allowable_values}."
      end
      @goals = goals
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          notes == o.notes &&
          creator_full_name == o.creator_full_name &&
    ...
    def hash
      [object, id, goals, time_horizon, notes, creator_full_name, target_portfolio].hash
    end
