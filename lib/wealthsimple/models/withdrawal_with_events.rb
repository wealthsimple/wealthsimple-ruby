...
module Wealthsimple
  ...
  class WithdrawalWithEvents
    ...
    def self.swagger_types
      {
        ...
        :'events' => :'Array<FundsTransferEvent>'
      }
    end
    ...
    def hash
      [id, type, status, funds_transfer_schedule_id, reject_reason, withdrawal_type, withdrawal_reason, tax_detail, bank_account_id, account_id, value, post_dated, external_id, created_at, updated_at, events].hash
    end
