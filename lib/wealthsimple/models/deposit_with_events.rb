...
module Wealthsimple
  ...
  class DepositWithEvents
    ...
    def hash
      [id, type, status, funds_transfer_schedule_id, reject_reason, bank_account_id, account_id, value, post_dated, external_id, created_at, updated_at, events].hash
    end
