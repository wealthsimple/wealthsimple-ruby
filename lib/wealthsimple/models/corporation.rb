...
module Wealthsimple
  ...
  class Corporation
    ...
    def valid?
      object_validator = EnumAttributeValidator.new('String', ["corporation"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["corporation"])
    ...
    def hash
      [email, phone_numbers, user_id, external_id, locale, mailing_address, jurisdictions, name, address, beneficial_owners, tax_identification_number, directors, created_at, updated_at, object, id].hash
    end
