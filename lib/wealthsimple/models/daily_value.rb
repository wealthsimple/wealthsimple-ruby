...
module Wealthsimple
  ...
  class DailyValue
    ...
    attr_accessor :net_liquidation_value

    attr_accessor :equity_value
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'net_liquidation_value')
        self.net_liquidation_value = attributes[:'net_liquidation_value']
      end

      if attributes.has_key?(:'equity_value')
        self.equity_value = attributes[:'equity_value']
      end
      ...
      if attributes.has_key?(:'summary_date')
        self.summary_date = attributes[:'summary_date']
      end
    ...
    def valid?
      object_validator = EnumAttributeValidator.new('String', ["daily_value"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["daily_value"])
    ...
    def hash
      [object, account_id, net_liquidation_value, equity_value, total_deposits, total_withdrawals, summary_date].hash
    end
