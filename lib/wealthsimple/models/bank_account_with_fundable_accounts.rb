...
module Wealthsimple
  ...
  class BankAccountWithFundableAccounts
    ...
    attr_accessor :fundable_accounts
    ...
    def self.attribute_map
      {
        ...
        :'owners' => :'owners',
        :'fundable_accounts' => :'fundable_accounts'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'fundable_accounts' => :'Array<AccountId>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'verifications')
      ...
      if attributes.has_key?(:'fundable_accounts')
        if (value = attributes[:'fundable_accounts']).is_a?(Array)
          self.fundable_accounts = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          owners == o.owners &&
          fundable_accounts == o.fundable_accounts
    end
    ...
    def hash
      [type, base_currency, corporate, jursidiction, account_name, institution_number, external_id, created_at, updated_at, id, account_number, verifications, owners, fundable_accounts].hash
    end
