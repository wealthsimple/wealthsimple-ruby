...
module Wealthsimple
  ...
  class TargetPortfolioAllocation
    attr_accessor :type
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ["currency", "equity", "mutual_fund", "bond"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["currency", "equity", "mutual_fund", "bond"])
    ...
    def hash
      [type, symbol, country_code, name, currency, exchange].hash
    end
