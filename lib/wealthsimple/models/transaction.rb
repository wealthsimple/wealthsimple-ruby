...
module Wealthsimple
  ...
  class Transaction
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'net_cash')
        self.net_cash = attributes[:'net_cash']
      end

      if attributes.has_key?(:'contribution_value')
        self.contribution_value = attributes[:'contribution_value']
      end

      if attributes.has_key?(:'process_date')
