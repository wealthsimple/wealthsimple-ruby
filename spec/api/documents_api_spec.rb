...
# Unit tests for Wealthsimple::DocumentsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DocumentsApi' do
  before do
    # run before each test
    @instance = Wealthsimple::DocumentsApi.new
  end
  ...
  describe 'test an instance of DocumentsApi' do
    it 'should create an instance of DocumentsApi' do
      expect(@instance).to be_instance_of(Wealthsimple::DocumentsApi)
    end
  end
  ...
  # unit tests for get_document__binary
  # 
  #  Retrieves the file (binary) representation of the Document resource. 
  # @param document_id The &#x60;id&#x60; of the Document entity.
  # @param [Hash] opts the optional parameters
  # @return [File]
  describe 'get_document__binary test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
