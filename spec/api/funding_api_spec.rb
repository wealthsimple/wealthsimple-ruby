...
# Unit tests for Wealthsimple::FundingApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FundingApi' do
  before do
    # run before each test
    @instance = Wealthsimple::FundingApi.new
  end
  ...
  describe 'test an instance of FundingApi' do
    it 'should create an instance of FundingApi' do
      expect(@instance).to be_instance_of(Wealthsimple::FundingApi)
    end
  end

  # unit tests for create_a_bank_account
  # 
  ...
  describe 'create_a_bank_account test' do
    it "should work" do
  ...
  # unit tests for create_withdrawal
  # 
  ...
  # @param [Hash] opts the optional parameters
  # @return [Withdrawal]
  describe 'create_withdrawal test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for get_withdrawal
  # 
  # Returns a withdrawal
  # @param funds_transfer_id The &#x60;id&#x60; of the Funds Transfer entity.
  # @param [Hash] opts the optional parameters
  # @return [WithdrawalWithEvents]
  describe 'get_withdrawal test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for list_withdrawals
  # 
  ...
  describe 'list_withdrawals test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
