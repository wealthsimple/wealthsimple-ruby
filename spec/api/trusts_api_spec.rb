...
# Unit tests for Wealthsimple::TrustsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrustsApi' do
  before do
    # run before each test
    @instance = Wealthsimple::TrustsApi.new
  end
  ...
  describe 'test an instance of TrustsApi' do
    it 'should create an instance of TrustsApi' do
      expect(@instance).to be_instance_of(Wealthsimple::TrustsApi)
    end
  end

  # unit tests for create_trust
  # 
  ...
  describe 'list_trusts test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_trust
  # 
