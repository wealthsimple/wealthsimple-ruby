...
# Unit tests for Wealthsimple::CorporationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CorporationsApi' do
  before do
    # run before each test
    @instance = Wealthsimple::CorporationsApi.new
  end
  ...
  describe 'test an instance of CorporationsApi' do
    it 'should create an instance of CorporationsApi' do
      expect(@instance).to be_instance_of(Wealthsimple::CorporationsApi)
    end
  end

  # unit tests for create_corporation
  # 
  ...
  describe 'list_corporations test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_corporation
  # 
  ...
  # @param [Hash] opts the optional parameters
  # @return [Corporation]
  describe 'update_corporation test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
