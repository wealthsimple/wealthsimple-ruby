...
# Unit tests for Wealthsimple::DailyValue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DailyValue' do
  before do
    # run before each test
    @instance = Wealthsimple::DailyValue.new
  end
  ...
  describe 'test an instance of DailyValue' do
    it 'should create an instance of DailyValue' do
      expect(@instance).to be_instance_of(Wealthsimple::DailyValue)
    end
  end
  describe 'test attribute "object"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["daily_value"])
  ...
  describe 'test attribute "net_liquidation_value"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "equity_value"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "summary_date"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
