...
# Unit tests for Wealthsimple::Corporation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Corporation' do
  before do
    # run before each test
    @instance = Wealthsimple::Corporation.new
  end
  ...
  describe 'test an instance of Corporation' do
    it 'should create an instance of Corporation' do
      expect(@instance).to be_instance_of(Wealthsimple::Corporation)
    end
  end
  ...
  describe 'test attribute "object"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["corporation"])
