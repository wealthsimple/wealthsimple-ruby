...
# Unit tests for Wealthsimple::FinancialInstitution
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FinancialInstitution' do
  before do
    # run before each test
    @instance = Wealthsimple::FinancialInstitution.new
  end
  ...
  describe 'test an instance of FinancialInstitution' do
    it 'should create an instance of FinancialInstitution' do
      expect(@instance).to be_instance_of(Wealthsimple::FinancialInstitution)
    end
  end
  describe 'test attribute "object"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["financial_institution"])
  ...
  describe 'test attribute "parent_institution"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "cuid"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "account_number_format"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
