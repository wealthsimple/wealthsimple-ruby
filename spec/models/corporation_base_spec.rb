...
# Unit tests for Wealthsimple::CorporationBase
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CorporationBase' do
  before do
    # run before each test
    @instance = Wealthsimple::CorporationBase.new
  end
  ...
  describe 'test an instance of CorporationBase' do
    it 'should create an instance of CorporationBase' do
      expect(@instance).to be_instance_of(Wealthsimple::CorporationBase)
    end
  end
