...
# Unit tests for Wealthsimple::CorporationUpdate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CorporationUpdate' do
  before do
    # run before each test
    @instance = Wealthsimple::CorporationUpdate.new
  end
  ...
  describe 'test an instance of CorporationUpdate' do
    it 'should create an instance of CorporationUpdate' do
      expect(@instance).to be_instance_of(Wealthsimple::CorporationUpdate)
    end
  end
