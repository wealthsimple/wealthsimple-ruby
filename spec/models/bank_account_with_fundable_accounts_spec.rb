...
# Unit tests for Wealthsimple::BankAccountWithFundableAccounts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BankAccountWithFundableAccounts' do
  before do
    # run before each test
    @instance = Wealthsimple::BankAccountWithFundableAccounts.new
  end
  ...
  describe 'test an instance of BankAccountWithFundableAccounts' do
    it 'should create an instance of BankAccountWithFundableAccounts' do
      expect(@instance).to be_instance_of(Wealthsimple::BankAccountWithFundableAccounts)
    end
  end
  ...
  describe 'test attribute "jursidiction"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "fundable_accounts"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
