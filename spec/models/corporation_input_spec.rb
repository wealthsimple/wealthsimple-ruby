...
# Unit tests for Wealthsimple::CorporationInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CorporationInput' do
  before do
    # run before each test
    @instance = Wealthsimple::CorporationInput.new
  end
  ...
  describe 'test an instance of CorporationInput' do
    it 'should create an instance of CorporationInput' do
      expect(@instance).to be_instance_of(Wealthsimple::CorporationInput)
    end
  end
