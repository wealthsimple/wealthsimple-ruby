...
# Unit tests for Wealthsimple::AccountTransferWithEvents
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountTransferWithEvents' do
  before do
    # run before each test
    @instance = Wealthsimple::AccountTransferWithEvents.new
  end
  ...
  describe 'test an instance of AccountTransferWithEvents' do
    it 'should create an instance of AccountTransferWithEvents' do
      expect(@instance).to be_instance_of(Wealthsimple::AccountTransferWithEvents)
    end
  end
  ...
  describe 'test attribute "relinquishing_institution"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
