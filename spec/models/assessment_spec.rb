...
# Unit tests for Wealthsimple::Assessment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Assessment' do
  before do
    # run before each test
    @instance = Wealthsimple::Assessment.new
  end
  ...
  describe 'test an instance of Assessment' do
    it 'should create an instance of Assessment' do
      expect(@instance).to be_instance_of(Wealthsimple::Assessment)
    end
  end
  describe 'test attribute "object"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["assessment"])
  ...
  describe 'test attribute "goals"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["mortgage", "retirement", "child_education", "income", "wedding", "speculation", "growth", "capital_preservation", "car", "education", "long_term", "inheritance", "home_deposit", "no_goal", "retirement_income", "other"])
       #validator.allowable_values.each do |value|
       #  expect { @instance.goals = value }.not_to raise_error
       #end
    end
  end
  ...
  describe 'test attribute "creator_full_name"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
