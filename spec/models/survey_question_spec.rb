...
# Unit tests for Wealthsimple::SurveyQuestion
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SurveyQuestion' do
  before do
    # run before each test
    @instance = Wealthsimple::SurveyQuestion.new
  end
  ...
  describe 'test an instance of SurveyQuestion' do
    it 'should create an instance of SurveyQuestion' do
      expect(@instance).to be_instance_of(Wealthsimple::SurveyQuestion)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["radio", "checkbox", "text", "range"])
  ...
  describe 'test attribute "range_limits"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "parent_question"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
