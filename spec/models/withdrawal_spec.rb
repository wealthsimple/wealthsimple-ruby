...
# Unit tests for Wealthsimple::Withdrawal
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Withdrawal' do
  before do
    # run before each test
    @instance = Wealthsimple::Withdrawal.new
  end
  ...
  describe 'test an instance of Withdrawal' do
    it 'should create an instance of Withdrawal' do
      expect(@instance).to be_instance_of(Wealthsimple::Withdrawal)
    end
  end
  ...
  describe 'test attribute "object"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["withdrawal"])
