...
# Unit tests for Wealthsimple::PersonUpdate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PersonUpdate' do
  before do
    # run before each test
    @instance = Wealthsimple::PersonUpdate.new
  end
  ...
  describe 'test an instance of PersonUpdate' do
    it 'should create an instance of PersonUpdate' do
      expect(@instance).to be_instance_of(Wealthsimple::PersonUpdate)
    end
  end
