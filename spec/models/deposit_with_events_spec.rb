...
# Unit tests for Wealthsimple::DepositWithEvents
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DepositWithEvents' do
  before do
    # run before each test
    @instance = Wealthsimple::DepositWithEvents.new
  end
  ...
  describe 'test an instance of DepositWithEvents' do
    it 'should create an instance of DepositWithEvents' do
      expect(@instance).to be_instance_of(Wealthsimple::DepositWithEvents)
    end
  end
