...
# Unit tests for Wealthsimple::TrustInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrustInput' do
  before do
    # run before each test
    @instance = Wealthsimple::TrustInput.new
  end
  ...
  describe 'test an instance of TrustInput' do
    it 'should create an instance of TrustInput' do
      expect(@instance).to be_instance_of(Wealthsimple::TrustInput)
    end
  end
