...
# Unit tests for Wealthsimple::TrustUpdate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrustUpdate' do
  before do
    # run before each test
    @instance = Wealthsimple::TrustUpdate.new
  end
  ...
  describe 'test an instance of TrustUpdate' do
    it 'should create an instance of TrustUpdate' do
      expect(@instance).to be_instance_of(Wealthsimple::TrustUpdate)
    end
  end
