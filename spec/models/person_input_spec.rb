...
# Unit tests for Wealthsimple::PersonInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PersonInput' do
  before do
    # run before each test
    @instance = Wealthsimple::PersonInput.new
  end
  ...
  describe 'test an instance of PersonInput' do
    it 'should create an instance of PersonInput' do
      expect(@instance).to be_instance_of(Wealthsimple::PersonInput)
    end
  end
