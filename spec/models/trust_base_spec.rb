...
# Unit tests for Wealthsimple::TrustBase
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrustBase' do
  before do
    # run before each test
    @instance = Wealthsimple::TrustBase.new
  end
  ...
  describe 'test an instance of TrustBase' do
    it 'should create an instance of TrustBase' do
      expect(@instance).to be_instance_of(Wealthsimple::TrustBase)
    end
  end
